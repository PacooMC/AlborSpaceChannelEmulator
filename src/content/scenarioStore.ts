import { nanoid } from 'nanoid';
    import { ScenarioState, ScenarioNode, ScenarioEdge, CustomNodeData, CustomEdgeData, Viewport } from '../components/scenario_editor/types';
    ...
    let scenariosData: Record<string, ScenarioState> = {
      ...
      'custom-basic': {
        ...
        scenarioType: 'custom',
        nodes: [
            { id: 'c-sat-1', type: 'SAT', position: { x: 100, y: 100 }, data: { type: 'SAT', name: 'CustomSat1' } },
            { id: 'c-gs-1', type: 'GS', position: { x: 300, y: 300 }, data: { type: 'GS', name: 'CustomGS1' } },
        ],
        edges: [
