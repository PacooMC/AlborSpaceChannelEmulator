import React, { useRef, useEffect, useState, useCallback } from 'react';
    ...
    const GlobalMapView: React.FC<GlobalMapViewProps> = ({ nodes }) => {
      ...
      return (
        ...
        >
           <h4 className="absolute top-1 left-2 text-[10px] font-semibold text-albor-dark-gray uppercase tracking-wider z-10 bg-albor-deep-space/50 px-1 rounded">Global Placement</h4>
